...
from wgan_model import WGAN, build_generator, build_discriminator, AGE_GROUPS, LATENT_DIM
...
def find_latest_checkpoint():
    ...
    for ckpt in checkpoints:
        try:
            ...
            continue # Ignoring checkpoints with non-integer epoch values (e.g., "best")
